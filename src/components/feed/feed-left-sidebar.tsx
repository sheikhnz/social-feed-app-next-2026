...
const EXPLORE_ITEMS = [
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
        ...
        <path d="M8.25 7.25 13.25 10 8.25 12.75z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M8 12v3M6.5 13.5h3" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
        <circle cx="15" cy="12.5" r="1" stroke="currentColor" strokeWidth="1.5" />
        <circle cx="17.5" cy="15" r="1" stroke="currentColor" strokeWidth="1.5" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    href: "#0",
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">

...
/* ─── Capital `feed.html` attachment icons (`fill=\"#666\"`, same SVGs as template) ─ */
...
/** Capital `feed.html` `_feed_inner_text_area_*` buckets (desktop shows labels + Post; mobile is icon-only + Post). */
...
/**
 * Capital template primary “Post” control (paper-plane + label).
 */
const PostSubmitButton = ({ className }: PostButtonProps) => (
  <div className={className ?? "_feed_inner_text_area_btn"}>
...
/**
 * Create-post composer aligned with `capital/feed.html`: floating label row, attachment row, responsive mobile strip.
 */
    ...
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      <div className="_feed_inner_text_area_box">
        <div className="_feed_inner_text_area_box_image">
          <Image src="/assets/images/txt_img.png" alt="" width={40} height={40} className="_txt_img" />
        </div>

          ...
          <li className="_feed_header_nav_item">
            <Link href="#" className="_feed_header_nav_link">
              <svg xmlns="http://www.w3.org/2000/svg" width="26" height="20" fill="none" viewBox="0 0 26 20">
                <path fill="#000" fillOpacity=".6" fillRule="evenodd" d={FRIENDS_ICON_PATH} clipRule="evenodd" />
              </svg>
            </Link>
          </li>
            ...
            <div className="_feed_notify_wrap">
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="22" fill="none" viewBox="0 0 20 22">
                  <path fill="#000" fillOpacity=".6" fillRule="evenodd" d={NOTIFY_ICON_PATH} clipRule="evenodd" />
                </svg>
          ...
          <li className="_feed_header_nav_item">
            <Link href="#" className="_feed_header_nav_link">
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="22" fill="none" viewBox="0 0 23 22">
                <path fill="#000" fillOpacity=".6" fillRule="evenodd" d={CHAT_ICON_PATH} clipRule="evenodd" />
              </svg>
